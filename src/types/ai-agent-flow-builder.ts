...
export const CAPTURE_SOURCE_OPTIONS: { value: string; label: string; default_target: string }[] = [
  ...
  { value: 'birth_date', label: 'Data de nascimento (DD/MM/AAAA)', default_target: 'contact.birth_date' },
...
export interface StepValidation {
  ...
  /** Tratativa de dúvidas do cliente no meio da etapa. */
  aside_answer?: StepAsideAnswer;
