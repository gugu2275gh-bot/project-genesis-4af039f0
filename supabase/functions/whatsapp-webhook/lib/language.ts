...
const TEMPLATES: Record<ChatLanguage, PromptTemplates> = {
  ...
  'es': {
    ...
    askLocationSpain: '¿Estás en España? Responde solo *Sí* o *No*.',
  ...
  'en': {
    ...
    askLocationSpain: 'Are you in Spain? Please reply only *Yes* or *No*.',
  ...
  'fr': {
    ...
    askLocationSpain: 'Êtes-vous en Espagne ? Répondez uniquement *Oui* ou *Non*.',
