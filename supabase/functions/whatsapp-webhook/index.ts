...
--- FIM DA INSTRUÇÃO ESPECIAL ---`
        ...
        // Pré-handoff = cadastro inicial (abertura → nome → email → interesse →
        // localização → aprofundamento → handoff). SÓ deve rodar para clientes NOVOS.
        // Se o contato já tem nome confiável + email + algum lead anterior,
        // pulamos todo o pré-handoff e marcamos o funil como 'livre' (KB liberada,
        // saudação de retorno pelo nome, sem refazer cadastro).
        ...
        try {
          ...
          console.warn('[RETURNING_CLIENT] non-blocking error:', rcErr instanceof Error ? rcErr.message : rcErr)
        }
