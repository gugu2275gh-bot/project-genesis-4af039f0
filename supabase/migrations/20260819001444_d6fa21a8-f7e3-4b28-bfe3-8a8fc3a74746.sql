...
DROP TRIGGER IF EXISTS trg_auto_cashflow_commission_paid ON public.commissions;
CREATE TRIGGER trg_auto_cashflow_commission_paid
AFTER INSERT OR UPDATE OF status ON public.commissions
FOR EACH ROW
EXECUTE FUNCTION public.auto_create_cashflow_on_commission_paid();